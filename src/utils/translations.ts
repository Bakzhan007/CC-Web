...
export const translations: Record<string, Translation> = {
  ...
  kz: {
    ...
    heroDescription: 'Каспий жағалауындағы премиум құрылыс және даму қызметтері. Сәулет өнерінің кереметтілігі теңдессіз сапамен ұштасады.',
    ...
    agenciesHeroDescription:
      'Цифрлық маркетинг, креативті дизайн және технологиялық шешімдер салаларында жоғары нәтижелерге қол жеткізетін тексерілген кәсіби агенттіктер желісімен танысыңыз.',

...
const Hero = () => {
  const { t } = useLanguage();
  return (
    <section className="bg-gradient-to-r from-brand-50 via-white to-orange-50">
      <div className="max-w-7xl mx-auto px-6 py-16 lg:py-24 grid md:grid-cols-2 gap-10 items-center">
        <div>
          <h1 className="text-4xl lg:text-6xl font-extrabold text-slate-900 mb-6">
            {t.careerHeroTitle}
            <span className="block text-brand-600">{t.careerHeroSubtitle}</span>
          </h1>
          <p className="text-lg lg:text-xl text-slate-700 mb-8">

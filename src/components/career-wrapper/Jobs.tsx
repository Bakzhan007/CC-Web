            ...
            >
              ...
              <div className="p-8 pb-6">
                <div className="flex items-start justify-between mb-6">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm">
                      <span className="flex items-center text-slate-600 bg-slate-100 px-3 py-2 rounded-full">
                      ...
                      <span className="flex items-center text-brand-600 bg-brand-50 px-3 py-2 rounded-full">
                  ...
                  <div className="space-y-3">
                    {job.requirements.map((req, reqIndex) => (
                      <div key={reqIndex} className="flex items-start">
                        <div className="flex-shrink-0 w-2 h-2 rounded-full bg-brand-600 mt-2 mr-3"></div>
                ...
                <button 
                  ...
                  className="w-full bg-brand-600 hover:bg-brand-700 text-white py-4 px-6 rounded-2xl font-semibold text-lg transition-all duration-300 flex items-center justify-center group/btn shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                  {t.careerApplyButton}
        ...
        {filteredJobs.length === 0 && (
          <div className="text-center py-16">
            <div className="bg-white rounded-2xl shadow-lg p-12 max-w-md mx-auto">
              ...
              <p className="text-xl text-slate-500 mb-4">No positions available</p>

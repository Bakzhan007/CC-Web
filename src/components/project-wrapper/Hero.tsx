...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800">
      ...
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-brand-600/20 via-transparent to-brand-600/20"></div>
        ...
        <div className="py-16 lg:py-24">
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              {t.projectsHeroTitle1} <span className="bg-gradient-to-r from-brand-500 to-brand-400 bg-clip-text text-transparent">{t.projectsHeroTitle2}</span>
            </h1>
          ...
          <div className="relative">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-brand-500 to-brand-600 rounded-2xl rotate-3 group-hover:rotate-6 transition-transform duration-300"></div>
                <div className="relative bg-white rounded-2xl p-8 transform group-hover:-translate-y-2 transition-all duration-300">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm text-slate-500 font-medium">{t.projectsStatsProjects}</div>
                    </div>
                  </div>
                  <div className="text-slate-700 font-medium">{t.projectsStatsCompletedProjects}</div>
                  <div className="w-full h-1 bg-brand-100 rounded-full mt-3">
                    <div className="w-4/5 h-full bg-gradient-to-r from-brand-500 to-brand-600 rounded-full"></div>
                  </div>
                </div>
              </div>
                ...
                <div className="relative bg-white rounded-2xl p-8 transform group-hover:-translate-y-2 transition-all duration-300">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm text-slate-500 font-medium">{t.projectsStatsCities}</div>
                    </div>
                  </div>
                  <div className="text-slate-700 font-medium">{t.projectsStatsCitiesPresence}</div>
                  <div className="w-full h-1 bg-brand-100 rounded-full mt-3">
                    <div className="w-2/5 h-full bg-gradient-to-r from-brand-500 to-brand-600 rounded-full"></div>
                  </div>
                </div>
              </div>
                ...
                <div className="relative bg-white rounded-2xl p-8 transform group-hover:-translate-y-2 transition-all duration-300">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm text-slate-500 font-medium">{t.projectsStatsYears}</div>
                    </div>
                  </div>
                  <div className="text-slate-700 font-medium">{t.projectsStatsYearsExperience}</div>
            ...
            {/* Decorative elements */}
            <div className="absolute -top-8 left-1/4 w-4 h-4 bg-brand-400 rounded-full animate-ping"></div>
            <div className="absolute -bottom-8 right-1/3 w-6 h-6 bg-brand-400 rounded-full animate-pulse"></div>
          </div>
        </div>
      </div>
    </section>
